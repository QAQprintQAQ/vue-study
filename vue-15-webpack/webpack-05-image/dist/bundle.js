...
//这里使用的是commonjs模块化规范
const {add, mul} = __webpack_require__(3);//common.js语法和es6还不同
...
console.log(__WEBPACK_IMPORTED_MODULE_0__js_info__["c" /* name */] + ' ' + __WEBPACK_IMPORTED_MODULE_0__js_info__["a" /* age */] + ' ' + __WEBPACK_IMPORTED_MODULE_0__js_info__["d" /* sex */] + ' ' + __WEBPACK_IMPORTED_MODULE_0__js_info__["b" /* height */]);

__webpack_require__(5);//不需要设置接收的变量,因为我们不需要css文件里面的内容,只需要添加一下依赖就行了
__webpack_require__(10);//不需要设置接收的变量,因为我们不需要less文件里面的内容,只需要添加一下依赖就行了
