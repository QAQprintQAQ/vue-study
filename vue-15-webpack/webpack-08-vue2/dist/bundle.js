...
var _require = __webpack_require__(9),
    add = _require.add,
    mul = _require.mul; //common.js语法和es6还不同
...
__webpack_require__(10); //不需要设置接收的变量,因为我们不需要css文件里面的内容,只需要添加一下依赖就行了
__webpack_require__(15); //不需要设置接收的变量,因为我们不需要less文件里面的内容,只需要添加一下依赖就行了
...
var vue = new _vue2.default({
  ...
  /*
    ...
    当我们的页面运行的时候,这里的template:``,中的html标签代码会替换掉index.html中的<div id="app"></div>。这是vue的工作了
   */
